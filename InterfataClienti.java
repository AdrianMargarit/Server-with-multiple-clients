...
public class InterfataClienti extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        convoArea.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        convoArea.setLineWrap(true);
        convoArea.setRows(5);
        convoArea.setWrapStyleWord(true);
        jScrollPane1.setViewportView(convoArea);
        sendArea.setColumns(20);
        sendArea.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        sendArea.setLineWrap(true);
        sendArea.setRows(5);
        sendArea.setText("Enter message...");
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        if(str.trim().equals("")){
            ...
            try {
            Clienti.OUT.writeUTF(str.trim());
            } catch (IOException ex) {
            Logger.getLogger(InterfataClienti.class.getName()).log(Level.SEVERE,
                    null, ex);
            }
        }
        sendArea.setText("");
